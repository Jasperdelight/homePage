  ...
  <div class="container-fluid">
    ...
    <section class="row">
      ...
      <h2 class="text-white text-center">Tower <a href="https://github.com/Jasperdelight/towerCheckpoint" target="_blank"> <i title="GitHub Page" class="mdi mdi-github"></i></a></h2>
      <div class="col-4">
